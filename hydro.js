(function () {
  function loadCodeMirror(callback) {
    if (window.CodeMirror) {
      console.log("CodeMirror already loaded, proceeding...");
      callback();
      return;
    }
    const scripts = [
    ...
    function loadNext(index) {
      if (index >= scripts.length) {
        console.log("All scripts loaded, initializing editor...");
        callback();
        return;
      }
      ...
      element.onerror = () => {
        ...
        if (fallback) {
          console.log(`Retrying ${name} with fallback: ${fallback}`);
          ...
          element.onload = () => {
            console.log(`${name} loaded via fallback`);
            loadNext(index + 1);
          };
  ...
  if (!window.JSHINT) {
    console.log("Initializing inline JSHint fallback");
  ...
  function createModal() {
    if (!document.querySelector("#hydro-styles")) {
      ...
      style.textContent = `
        ...
        .toolbar-menu-item:hover .toolbar-submenu {
          display: block;
        }
        ...
        .custom-modal-ok, .custom-modal-cancel {
          padding: 8px 16px;
          background: #007acc;
          border: none;
          border-radius: 5px;
    ...
    content.className = "hydro-content";
    ...
    fileMenu.className = "toolbar-menu-item";
    fileMenu.textContent = "File";
    let fileSubmenu = document.createElement("div");
    fileSubmenu.className = "toolbar-submenu";
    ...
    editMenu.className = "toolbar-menu-item";
    editMenu.textContent = "Edit";
    let editSubmenu = document.createElement("div");
    editSubmenu.className = "toolbar-submenu";
    ...
    runMenu.className = "toolbar-menu-item";
    runMenu.textContent = "Run";
    let runSubmenu = document.createElement("div");
    runSubmenu.className = "toolbar-submenu";
    ...
    viewMenu.className = "toolbar-menu-item";
    viewMenu.textContent = "View";
    let viewSubmenu = document.createElement("div");
    viewSubmenu.className = "toolbar-submenu";
    ...
    newTabBtnPlaceholder.className = "new-tab-btn";
        ...
        const options = {
          ...
          extraKeys: {
            ...
            ".": function (cm) {
              ...
              console.log("Dot pressed, triggering autocomplete");
    ...
    function ensureEditorVisible() {
      ...
      if (activeTabIndex >= 0 && editors[activeTabIndex]) {
        ...
        if (wrapper) {
          ...
          if (display === "none") {
            console.log("Editor was hidden, restoring visibility");
        ...
        console.log("Editor container dimensions:", container);
        const modalDisplay = window.getComputedStyle(modal).display;
        console.log("Modal display state:", modalDisplay);
      }
    }
    ...
    function createTab(index, content = "") {
      ...
      console.log(`Tab ${index} created`);
      return tab;
    }

    function switchTab(index) {
      console.log(`Attempting to switch to tab ${index}. Editors length: ${editors.length}, ActiveTabIndex: ${activeTabIndex}`);
      if (index < 0 || index >= editors.length || !editors[index] || typeof editors[index].getWrapperElement !== "function") {
        ...
        if (activeTabIndex >= 0 && editors[activeTabIndex]) {
          console.log(`Switching to fallback tab ${activeTabIndex}`);
    ...
    function removeTab(index) {
      ...
      tabs.splice(index, 1);
      console.log(`Tab ${index} removed. Editors length: ${editors.length}, Tabs length: ${tabs.length}`);
    ...
    function addTab(content = "") {
      ...
      console.log(`Adding tab ${index} with content length: ${content.length}`);
      ...
      console.log(`Editors length: ${editors.length}, Tabs length: ${tabs.length}`);
      setTimeout(() => {
        switchTab(index);
      }, 0);
    }
      ...
      input.onchange = (e) => {
        ...
        if (file) {
          ...
          reader.onload = (e) => {
            ...
            console.log("File loaded into editor");
          };
          reader.onerror = () => {
      ...
      modal.querySelector(".custom-modal-ok").addEventListener("click", () => {
        ...
        fetch(urlInput)
          ...
          .then(content => {
            ...
            console.log(`Script loaded from ${urlInput}`);
            closeModal();
          })
          .catch(error => {
    ...
    clearBtn.addEventListener("click", () => {
      ...
      modal.querySelector(".custom-modal-ok").addEventListener("click", () => {
        ...
        console.log("Current tab cleared");
        closeModal();
      });
    });
    ...
    lintBtn.addEventListener("click", () => {
      ...
      if (window.CodeMirror.lint && !window.lintFailed && window.JSHINT) {
        ...
        console.log("Linting performed:", annotations);
      } else {
        ...
        console.log("Fallback linting performed:", annotations);
      }
    });
    ...
    debugBtn.addEventListener("click", () => {
      ...
      editors.forEach((editor, index) => {
        if (editor) console.log(`Tab ${index + 1} Content:`, editor.getValue());
      });
      console.log("Page URL:", window.location.href);
      console.log("Page Scripts:", document.querySelectorAll("script"));
      console.log("Lint available:", !!window.CodeMirror.lint && !window.lintFailed && !!window.JSHINT);
      console.log("Hint available:", !window.hintFailed);
    });
    ...
    pageInfoBtn.addEventListener("click", () => {
      ...
      addTab(info);
      console.log("Page info loaded into new tab");
    });
        ...
        if (script.src) {
          fetch(script.src)
            ...
            .then((content) => {
              ...
              console.log(`Script ${index + 1} loaded from ${script.src}`);
            })
            .catch((error) => {
          ...
          console.log(`Inline script ${index + 1} loaded`);
        }
      });
      console.log("All page scripts loaded. Total tabs: ", editors.length);
    });
    ...
    clearPageBtn.addEventListener("click", () => {
      ...
      modal.querySelector(".custom-modal-ok").addEventListener("click", () => {
        ...
        console.log("Page content cleared except for Hydro Editor");
        closeModal();
      });
    });
  ...
  console.log("Hydro Code Editor initialized. Autocomplete triggers after 1+ characters or on '.', or use Ctrl+Space. Errors/warnings are shown in the editor and via Run > Lint.");
})();